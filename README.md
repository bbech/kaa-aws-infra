...
```bash
kaa-infra$ sam logs -n StockCheckerFunction --stack-name kaa-infra --tail
```
...
```bash
kaa-infra$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name kaa-infra
```
